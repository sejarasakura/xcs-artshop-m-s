...
namespace WebApplicationAssigment.pages.main.Authentication.Profile
{
    public partial class MyOrder : System.Web.UI.Page
    {
        ...
        protected void RepeaterOrder_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            try
            {
                rpt_child.DataSource = OrderDetailsDataTable(Guid.Parse(MyLiteral.Text));
                rpt_child.DataBind();
            }
            catch (Exception ex)
            {  
        ...
        protected string convert_css_class(Guid userRole)
        {
            if (userRole == Guid.Parse("20bd9f32-b531-4b7f-a89a-80babe9aa707"))
                return "label-warning";
            else if (userRole == Guid.Parse("80e85ebb-7401-45be-8080-4d16df2177bf"))
                return "label-danger";
            else if (userRole == Guid.Parse("dd4a293f-8a90-4050-acae-9efafc5b87fe"))
                return "label-danger";
            else if (userRole == Guid.Parse("c595596d-8980-4138-bc20-a91056e1b1ce"))
