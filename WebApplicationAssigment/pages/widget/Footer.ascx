                ...
                <div class="row">
                    <div class="col-sm-4 ">
                        ...
                        <div class="footer-zoom">
                            <a href="#" class="artshop-footer-style">Profile
                            </a>
                        </div>
                        <div class="footer-zoom">
                            <a href="#" class="artshop-footer-style">Sell history
                            </a>
                        </div>
                        <div class="footer-zoom">
                            <a href="#" class="artshop-footer-style">My Art
                            </a>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        ...
                        <div class="footer-zoom">
                            <a href="#" class="artshop-footer-style">Payment History
                            </a>
                        </div>
                        <div class="footer-zoom">
                            <a href="#" class="artshop-footer-style">View cart
                            </a>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        ...
                        <div class="footer-zoom">
                            <a href="#" class="artshop-footer-style">Paint
                            </a>
                        </div>
                        <div class="footer-zoom">
                            <a href="#" class="artshop-footer-style">Photograph
                            </a>
                        </div>
                        <div class="footer-zoom">
                            <a href="#" class="artshop-footer-style">Drawing
                            </a>
                        </div>
                    </div>
                </div>
